...
/**
 * Servlet implementation class CVReferenceServlet2
 */
@WebServlet("/CVReferenceServlet2")
public class CVReferenceServlet2 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CVReferenceServlet2() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String ReferencePhone  =request.getParameter("ReferencePhone") +request.getParameter("ReferencePhoneCode");
