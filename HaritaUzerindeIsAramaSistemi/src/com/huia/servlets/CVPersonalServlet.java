...
/**
 * Servlet implementation class CVPersonalServlet
 */
@WebServlet("/CVPersonalServlet")
public class CVPersonalServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CVPersonalServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		cvImp.AddCvInfoPersonal(cv);
		
		response.sendRedirect("CVEducationalInfo.jsp");
	}
