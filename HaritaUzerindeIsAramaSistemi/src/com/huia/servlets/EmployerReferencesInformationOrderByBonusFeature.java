 ...
 */
@WebServlet("/employerReferencesInformationOrderByBonusFeature")
public class EmployerReferencesInformationOrderByBonusFeature
		extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		html += "<thead><tr><th>Adı Soyadı</th><th>Başvuru Tarihi</th><th>Mesaj</th><th>Cevapla</th><th>Puanı</th></tr></thead><tbody>";

		applicantinformation = addao.getApplicantsOrderByBonusFeature(adid);
		k = 0;
		while (k != (applicantinformation.size())) {
			...
			html += "<h4 class=\"modal-title\" id= \"myModalLabel\"></h4></div><div class=\"modal-body\"><h3>"
					+ message + "</h3></div>";
			html += "<div class=\"modal-footer\"><button type=\"button\" class=\"btn btn-default\" onclick=\"closeModal("
					+ referenceid + ",'myModal" + referenceid
