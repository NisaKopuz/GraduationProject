...
Connection con = conn.getConnection();
 ...
 String query =  "SELECT * FROM tblMessage WHERE messageTo=? order by messageId desc";
...
<body >
   ...
   <div class="form-group">
	...
	<tbody id="details">
      	<tr>
		<td><label><input type="checkbox" name="messageId" value="<%=messageId%>"></label></td>
        <td><%=messageFrom%></td>
...
%>	</tbody>
						...
						<div class="form-group">
							<div class="col-sm-offset-4 col-sm-4">
								<button type="submit" class="btn btn-danger btn-block" >Seçtiğim Mesajları Sil</button>
