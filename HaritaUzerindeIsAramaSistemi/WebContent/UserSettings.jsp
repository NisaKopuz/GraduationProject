...
<form class="form-horizontal" role="form" action="userSettingsServlet" method="POST">
    ...
    <div class="col-sm-4" id="name">
 	 <input type="text"   class="form-control" id="nname" name="name" value=<%=Name%>/>
    </div>
    
  	<br/><br/><br/>
     <label class="control-label col-sm-2">Soyad:</label>
    <div class="col-sm-4" id="surname">
    <input type="text"   class="form-control" id="ssurname" name="surname" value=<%=Surname%>/>
    </div>
    
    <br/><br/><br/>
     <label class="control-label col-sm-2">E-posta Adresi:</label>
    <div class="col-sm-4">
    <input type="text"   class="form-control" id="e-mail" name="email" value=<%=Email %>/>
    </div>
    ...
    <div class="col-sm-4">
    <input type="text"   class="form-control" id="phonenumber" name="phonenumber" value=<%=Cellphone%>/>
    </div>
  ...
  <a id="lnkSifreDegistir" href="javascript:void(0);" onclick="GosterGizle()" class="link">
     ...
     <div align="right">
   <button type="submit" class="btn btn-primary btn-xs" >Kaydet</button>    
    </div>
