...
<nav class="navbar navbar-inverse navbar-fixed-top">
 ...
 <form class="form-horizontal" data-toggle="validator" name="sform" method="POST" action="CVPersonalServlet" data-fv-framework="bootstrap"
		...
		<p><br><br></p>
			<ul class="nav nav-pills col-md-offset-2   ">
				...
				<li class="active" ><a data-toggle="pill" href="CVPersonalInformation.jsp">Kişisel Bilgiler</a></li>
				<li><a data-toggle="pill" href="CVEducationalInfo.jsp">Eğitim Bilgileri</a></li>
				<li><a data-toggle="pill" href="CCVBusinessInfo.jsp">İş Deneyimi</a></li>
 ...
 <div class="form-group">
      ...
      <div class="col-sm-7">          
        <input type="text" class="form-control"  name="ID" placeholder="TC Kimlik Numaranız" required placeholder="" maxlength="11" onkeypress="return isNumberKey(event);">
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-1">
        <input TYPE=radio name="genderRadioBttn" value="Kadın"  required placeholder="">Kadın <BR>        
      </div>
      
       <div class="col-sm-1">
        <input TYPE=radio name="genderRadioBttn" value="Erkek" >Erkek <BR>        
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-7">          
        <input type="text" id="datepicker" class="form-control" name="BirthDate" required placeholder="">
      </div>
    </div>
 ...
 <div class="form-group">
      ...
      <div class="col-sm-7">          
        <input type="text" class="form-control" name="BirthPlace" placeholder="Dogum Yeriniz">
      </div>
    </div>
  ...
  <option value="zimbabwean">Zimbabwean</option>
    ...
    <div class="form-group">
      <label class="control-label col-sm-5" for="DrivingLicence">Surucu Belgesi &nbsp;&nbsp;&nbsp;:</label>
       ...
       <div class="col-sm-1">
        <input TYPE=radio name="DrivingLicence" value="Var" > Var <BR>        
      </div>
      
       <div class="col-sm-1">
        <input TYPE=radio name="DrivingLicence" value="Yok" > Yok <BR>        
      </div>
      </div>
      <hr>
      <div class="form-group">
      <label class="control-label col-sm-5" for="DisabledInfo">Engel Bilgisi &nbsp;&nbsp;&nbsp;:</label>
         <div class="col-sm-1">
        <input TYPE=radio name=DisabledInfo value="Var"  onchange="change()">  Var <BR>        
      </div>
      <div class="col-sm-1">
        <input TYPE=radio name=DisabledInfo value="Yok"  onchange="change()">  Yok <BR>        
      </div>
      </div>
    ...
    <div class="col-sm-1">
        <input TYPE="text" class="form-control" name="HealthCertificatetxt" placeholder="Açıklama" >      
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-1">
        <input TYPE="text" class="form-control" name="ChronicIlnesstxt" placeholder="Açıklama">      
      </div>
    </div>
	 ...
	 <div class="form-group">
      <label class="control-label col-sm-5" for="UsedMedicine">Devamlı Kullanılan ilaç Var Mı? &nbsp;&nbsp;&nbsp;:</label>
       ...
       <div class="col-sm-1">
        <input TYPE="text" class="form-control" name="UsedMedicinetxt" placeholder="Açıklama">      
      </div>
    </div>
...
<div class="form-group">
      <label class="control-label col-sm-5" for="CommunicableIllnesslbl">Bulaşıcı Herhangi Bir Hastalığınız Var M ı? &nbsp;&nbsp;&nbsp;:</label>
       ...
       <div class="col-sm-1">
        <input TYPE="text" class="form-control" name="CommunicableIllnesstxt" placeholder="Açıklama" >      
      </div>
    </div>
...
<div class="form-group">
      <label class="control-label col-sm-5" for="LossOfConsciousness  ">Arada Bilinç Kaybı Yaşanan Durumlar Oluyor Mu? &nbsp;&nbsp;&nbsp;:</label>
       ...
       <div class="col-sm-1">
        <input TYPE="text" class="form-control" name="LossOfConsciousnesstxt" placeholder="Açıklama" >      
      </div>
    </div>
