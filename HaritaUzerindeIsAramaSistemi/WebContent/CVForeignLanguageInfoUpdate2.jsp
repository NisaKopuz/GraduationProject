			...
			<div class="tab-content text-center">
				<div id="home" class="tab-pane fade in active">
					...
					<div class="container center ">
						...
						<div class="form-group">
							<label class="control-label col-sm-9" for="Language">Dil Adını Seçin&nbsp;&nbsp;&nbsp;:</label>
							<div class="col-sm-3">
							<% 
							while (rs6.next()) {%>
			
				 				<a href="CVForeignLanguageInfoUpdate.jsp?idLanguage=<%=rs6.getString("idLanguage")%>"><%=rs6.getString("Language")%></a><br>
