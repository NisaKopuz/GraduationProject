...
%>
<body onload="showDepartment('<%=companyid%>')">
	...
	<script>
	function showDepartment(companyId) {
		var xhttp = new XMLHttpRequest();
		xhttp.onreadystatechange = function() {
			if (xhttp.readyState == 4 && xhttp.status == 200) {
				
				document.getElementById("depts").innerHTML = xhttp.responseText;

			}
		};
		xhttp.open("POST", "ShowDepartments", true);
	...
	function validate()
	{
		...
		var values = $('#jobfield-multiple-selected').val();
		var netsalaryvalues= $('#netsalary').val();
		var positiontypevalues = $('#positiontype').val();
		var sectorvalues= $('#sector-multiple-selected').val();
		var positionlevelvalues= $('#positionlevel').val();
		var cityvalues=$('#city').val();
		var nicInstance = nicEditors.findEditor('qualifications');
		var qualifications = nicInstance.getContent();
		...
		if(document.getElementById("title").value=="")
			...
			message+="Duyuru başlığını boş bırakmayınız.<br>";
		
			}
		
		 if(values==undefined)
			 message+="İş alanını seçiniz.<br>";
			
		
		 if(positiontypevalues==undefined)
			 message+="Çalışma şeklini seçiniz.<br>";
				
			if(qualifications=="<br>")
				message+="Genel nitelikleri giriniz.<br>"
		
		 if(sectorvalues==undefined)
			 message+="Firma sektörünü seçiniz.<br>";
		
		
		
		if(positionlevelvalues==undefined)
			message+="Pozisyon seviyesini seçiniz.<br>";
		
		if(document.getElementById("numberofpersonnel").value=="")
			message+="Personel sayısını giriniz.<br>";
		
		
		if(netsalaryvalues==undefined)
			message+="Maaş aralığını seçiniz.<br>"
			
		if(document.getElementById("lastapplydate").value=="")
			message+="İlan kaldırış tarihini giriniz.<br>";		
	
		if(cityvalues==undefined)
			message+="İlanın yayınlanacağı şubesini seçiniz.<br>";
			
		if(document.getElementById("minage").value=="")
			{
				if(document.getElementById("maxage").value!="")
					message+="Lütfen minimum yaş aralığını giriniz."
		...
		if(document.getElementById("maxage").value=="")
			{
				if(document.getElementById("minage").value!="")
					message+="Lütfen maximum yaş aralığını giriniz."
			
			}
	
		if((document.getElementById("title").value!="")&&(values!=undefined)&&(positiontypevalues!=undefined)&&(sectorvalues!=undefined)&&(positionlevelvalues!=undefined&&(document.getElementById("numberofpersonnel").value!=""))&&(netsalaryvalues!=undefined)&&(document.getElementById("lastapplydate").value!="")&&(cityvalues!=undefined)&&(qualifications!="<br>"))
		...
		<div class="row">
			...
			<ul class="nav nav-pills nav-justified">
				<li role="presentation" class="active"><a data-toggle="pill"
					href="#menu1">İlan Bilgileri</a></li>
				<li role="presentation"><a data-toggle="pill" href="#menu2">Aday
						Bilgileri</a></li>
				<li role="presentation"><a data-toggle="pill" href="#menu3" onclick="showDepartment('<%=companyid%>')" >Yayınlama
						Bilgileri</a></li>
			</ul>
		</div>

		<form role="form" name="myForm" action="addadvert" method="POST" >
			<div class="tab-content">

				<div id="menu1" class="tab-pane fade in active">
					<div class="row">
						<br>
						<h4 class="text-center">İlan bilgilerini aşağıda
							belirtebilirsiniz.(Bu alan zorunludur.)</h4>
						<br>
						<div class="col-xs-6">
									...
									<div class="form-group">
										...
										<div class="col-xs-8">
											<input type="text" class="form-control" id="companyname"
												name="companyname" placeholder="<%=companyname%>" readonly>
										</div>
									</div>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="row">
									<br>
									<div class="form-group">
										<label class="control-label col-xs-4" for="positiontype">Çalışma
											Şekli</label>
										<div class="col-xs-8">
											<select class="form-control" id='positiontype'
												name="positiontype" style="width: 300px">
						...
						<div class="col-xs-6">
								...
								<div class="form-group">
									...
									<div class="col-xs-8">
										<select class="form-control" id='positionlevel'
											name="positionlevel" style="width: 300px">
							...
							<div class="row">
								<br>
								<div class="form-group">
									<label class="control-label col-xs-4" for="numberofpersonnel">
										İşe Alınacak Personel Sayısı</label>
									<div class="col-xs-4">
										<input type="text" class="form-control" id="numberofpersonnel"
											name="numberofpersonnel">
									</div>
									<div class="col-xs-4">
										<input type="checkbox" name="numberofpersonnelcheckbox"
											value="numberofpersonnelcheckbox"> &nbsp; Aday
										Görebilsin
									</div>
								</div>
							</div>
							<div class="row">
								...
								<div class="form-group">
									...
									<div class="col-xs-4">
										<select class="form-control" id='netsalary' name="netsalary">
											<option selected disabled>Seçiniz</option>
									...
									<div class="col-xs-4">
										<label class="checkbox-inline"> <input type="checkbox"
											name="netsalarycheckbox" value="netsalarycheckbox">
											Aday Görebilsin
										</label>
									</div>
								</div>
					...
					<div class="row">
						<br>
						<div class="form-group">
							<label class="control-label col-xs-2" for="qualifications">
				...
				<div id="menu2" class="tab-pane fade">
					<div class="row">
						<br>
						<h4 class="text-center">Yayınlamak istediğiniz pozisyon için,
							aradığınız aday bilgilerini aşağıda belirtebilirsiniz.</h4>
						<br>
						<div class="col-xs-6">
							<div class="form-group">
								<div class="row">
								...
								<div class="row">
									...
									<div class="col-xs-2 pull-left">
										<input name="upperph" id="upperph" type="checkbox" value="1">
										ve üstü
									</div>
								</div>
							</div>
								...
								<div class="row">
									...
									<div class="col-xs-8 text-center">
										<select class="form-control"
											...
											id="pastpositions-multiple-selected" multiple="multiple">
											<option value="1">Üst Düzey Yönetici</option>
											<option value="2">Orta Düzey Yönetici</option>
											<option value="3">Yönetici Adayı</option>
											<option value="4">Uzman</option>
								...
								<div class="row">
									...
									<div class="col-xs-8 text-center">
										<select class="form-control"
											...
											id="pastsectors-multiple-selected" multiple="multiple">
											<option value="100">Arşiv Yönetimi ve Saklama</option>
											<option value="200">Atık Yönetimi ve Geri Dönüşüm</option>
											<option value="300">Basım-Yayın</option>
											<option value="301">&nbsp;&nbsp;Elektronik
								...
								<div class="row">
									...
									<div class="col-xs-8 text-center">
										<select class="form-control"
											...
											id="university-multiple-selected" multiple="multiple">
								...
								<div class="row">
									...
									<div class="col-xs-8 text-center">
										<select class="form-control"
											...
											id="universitysection-multiple-selected" multiple="multiple">
											...
											<option value="104">Amerikan Kültürü ve Edebiyatı</option>
											...
											<option value="180">Azerbaycan Türkçesi ve Edebiyatı
											</option>
											...
											<option value="189">Bilişim Sistemleri Mühendisliği
											</option>
											<option value="39">Bitki Koruma</option>
											<option value="240">Bitkisel Üretim ve Teknolojileri
											</option>
											...
											<option value="49">Çağdaş Türk Lehçeleri ve
												Edebiyatları</option>
											<option value="79">Çağdaş Yunan Dili ve Edebiyatı</option>
											<option value="64">Çalışma Ekonomisi ve Endüstri
												İlişkileri</option>
											<option value="177">Cevher Hazırlama Mühendisliği</option>
											...
											<option value="24">Elektrik-Elektronik Mühendisliği
											</option>
											...
											<option value="225">Endüstri Sistemleri Mühendisliği
											</option>
											<option value="152">Endüstri Ürünleri Tasarımı</option>
											<option value="72">Endüstriyel Tasarım</option>
											<option value="146">Enerji Sistemleri Mühendisliği</option>
											...
											<option value="153">Gastronomi ve Mutfak Sanatları</option>
											<option value="63">Gazetecilik</option>
											<option value="176">Gemi İnşaatı ve Gemi Makineleri
												Mühendisliği</option>
											...
											<option value="151">Görme Engelliler Öğretmenliği</option>
											...
											<option value="186">Havacılık ve Uzay Mühendisliği</option>
											<option value="221">Hemşirelik ve Sağlık Hizmetleri
											</option>
											...
											<option value="159">İç Mimarlık ve Çevre Tasarımı</option>
											...
											<option value="103">İlköğretim Din Kültürü ve Ahlak
												Bilgisi Öğretmenliği</option>
											<option value="2">İlköğretim Matematik Öğretmenliği
											</option>
											...
											<option value="213">İngiliz Dili ve Karşılaştırmalı
												Edebiyat</option>
											<option value="3">İngilizce Öğretmenliği</option>
											<option value="54">İnşaat Mühendisliği</option>
											<option value="70">İşitme Engelliler Öğretmenliği</option>
											...
											<option value="198">Makine ve İmalat Mühendisliği</option>
											<option value="29">Maliye</option>
											<option value="50">Malzeme Bilimi ve Mühendisliği</option>
											...
											<option value="122">Moleküler Biyoloji ve Genetik</option>
											<option value="232">Muhasebe ve Finans Yönetimi</option>
											<option value="215">Mühendislik ve Doğa Bilimleri
												Programları</option>
											<option value="167">Odyoloji</option>
											<option value="4">Okul Öncesi Öğretmenliği</option>
											<option value="162">Orman Endüstrisi Mühendisliği</option>
											...
											<option value="185">Petrol ve Doğalgaz Mühendisliği
											</option>
											...
											<option value="238">Reklamcılık ve Halkla İlişkiler
											</option>
											...
											<option value="107">Siyaset Bilimi ve Kamu Yönetimi
											</option>
											<option value="125">Siyaset Bilimi ve Uluslararası
												İlişkiler</option>
											...
											<option value="43">Toprak Bilimi ve Bitki Besleme</option>
											...
											<option value="222">Uluslararası İlişkiler ve Avrupa
												Birliği</option>
											<option value="236">Uluslararası İşletmecilik</option>
											<option value="229">Uluslararası Lojistik</option>
											<option value="212">Uluslararası Ticaret ve Finans</option>
											<option value="48">Uluslararası Ticaret ve Finansman
											</option>
											...
											<option value="217">Yönetim Bilimleri Programları</option>
						...
						<div class="col-xs-6">
							<div class="row">
								...
								<div class="col-xs-4">
									<label> <input name="msperformed" id="msperformed"
										type="checkbox" value="1"> Yapıldı
									</label>
								</div>
								<div class="col-xs-4">
									<label> <input name="msprivileged" id="msprivileged"
										type="checkbox" value="1"> Muaf
									</label>
								</div>
							</div>
							<div class="row">
								...
								<div class="col-xs-4">
									<label> <input name="msnotperformed"
										id="msnotperformed" type="checkbox" value="1">
										Yapılmadı
									</label>
								</div>
								<div class="col-xs-4">
									<label> <input name="msprobated" id="msprobated"
										type="checkbox" value="1"> Tecilli
									</label>
								</div>
							</div>
							...
							<div class="row">
								...
								<div class="col-xs-8">
									<label class="radio-inline"> <input type="radio"
										name="exp" id="expsame" value="expsame"> Farketmez
									</label> <label class="radio-inline"> <input type="radio"
										name="exp" id="notexp" value="notexp"> Tecrübesiz
									</label> <label class="radio-inline"> <input type="radio"
										name="exp" id="exp" value="exp"> Tecrübeli
									</label>
								</div>
							</div>
							<div class="row">
								...
								<div class="col-xs-8">
									<label class="radio-inline"> <input type="radio"
										name="gender" id="gendersame" value="gendersame"> Farketmez
									</label> <label class="radio-inline"> <input type="radio"
										name="gender" id="genderwoman" value="genderwoman"> Kadın
									</label> <label class="radio-inline"> <input type="radio"
										name="gender" id="genderman" value="genderman"> Erkek
									</label>
								</div>
							</div>
							<div class="row">
							...
							<div class="row">
								...
								<div class="col-xs-8 text-center">
									<select name="dlicence" class="form-control" id="dlicence">
										<option selected disabled>Seçiniz</option>
							...
							<div class="row">
								...
								<div class="col-xs-8 text-center">
									<select class="form-control" name="lang-multiple-selected"
										id="lang-multiple-selected" multiple="multiple">
				...
				<div id="menu3" class="tab-pane fade">
					...
					<div class="col-xs-4">
						...
						<br>
						<div class="form-group">
							<label class="control-label col-sm-5" for="lastapplydate">İlan
				   ...
				   <button type="button" class="btn btn-primary btn-block" onclick="validate()"  >Yayınla</button>			
		<!--  
		<button type="button" data-target="#modal" data-toggle="modal" class="btn btn-primary btn-block">Yayınla</button>
				-->
	<!-- Modal -->
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Yayınlamak istediğinize emin misiniz?</p>
      </div>
  ...
  <script type="text/javascript">
      $(document).ready(function() {
       ...
       $('#jobfield-multiple-selected').multiselect({
           ...
           onChange: function(option,checked) {
            // Get selected options.
              var selectedOptions = $('#jobfield-multiple-selected option:selected');
               if (selectedOptions.length >= 5) {
                // Disable all other checkboxes.
            	    var nonSelectedOptions = $('#jobfield-multiple-selected option').filter(function() {
                   	 return !$(this).is(':selected');
                  });
                                     
       			 var dropdown = $('#jobfield-multiple-selected').siblings('.multiselect-container');
                  nonSelectedOptions.each(function() {
                  var input = $('input[value="' + $(this).val() + '"]');
              		input.prop('disabled', true);
                 	input.parent('li').addClass('disabled');
                   	...
                   	// Enable all checkboxes.
                    var dropdown = $('#jobfield-multiple-selected').siblings('.multiselect-container');
                    $('#jobfield-multiple-selected option').each(function() {
                      var input = $('input[value="' + $(this).val() + '"]');
                       input.prop('disabled', false);
                       input.parent('li').addClass('disabled');
                       });
