...
String Surname = "";
String Email = "";
 String query =  "SELECT Name,Surname,Email FROM tblUserRegistration WHERE UserName=?";
...
<body onload="MyFunction()">
	...
	<form class="form-horizontal" data-toggle="validator" name="sform" method="POST" action="CVContactServlet" data-fv-framework="bootstrap"
			...
			<div class="tab-content text-center">
				<div id="home" class="tab-pane fade in active">
					...
					<div class="container center ">
						...
						<div class="form-group">
							<label class="control-label col-sm-5" for="Name">Adım
								*&nbsp;&nbsp;&nbsp;:</label>
							<div class="col-sm-7">
								<input type="text" class="form-control" name="Name"
									placeholder="<%=Name%>" value="<%=Name%>"required placeholder="" readonly>
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-sm-5" for="Surname">Soyadım
								*&nbsp;&nbsp;&nbsp;:</label>
							<div class="col-sm-7">
								<input type="text" class="form-control" name="Surname"
									placeholder="<%=Surname%>" value="<%=Surname%>" required placeholder="" readonly>
							</div>
						</div>

						<div class="form-group">
							<label class="control-label col-sm-5" for="Title">Ünvanım
								*&nbsp;&nbsp;&nbsp;:</label>
							<div class="col-sm-7">
								<input type="text" class="form-control" name="Title"
									placeholder="örn:Yazılım mühendisi" required placeholder="">
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-sm-5" for="Country">Ülke
								*&nbsp;&nbsp;&nbsp;:</label>
							<div class="col-sm-7">
								<select class="form-control" name="sel1" onchange="changeval()" required ><script>
						...
						<div class="form-group">
							<label class="control-label col-sm-5" for="City">Şehir
								*&nbsp;&nbsp;&nbsp;:</label>
							<div class="col-sm-7">
						...
						<div class="form-group">
							<label class="control-label col-sm-5" for="Town">İlçe
								*&nbsp;&nbsp;&nbsp;:</label>
							<div class="col-sm-7">
						...
						<div class="form-group">
							<label class="control-label col-sm-5" for="District">Semt
								*&nbsp;&nbsp;&nbsp;:</label>
							<div class="col-sm-7">
						...
						<div class="form-group">
							<label class="control-label col-sm-5" for="HomePhoneNumber">Ev
								Telefonu &nbsp;&nbsp;&nbsp;:</label>
							...
							<div class="col-sm-2 control-label col-sm-offset-0 ">
								<input type="text" class="form-control" name="HomePhoneNumber"
									placeholder="XXXXXXXXXX" maxlength="10" onkeypress="return isNumberKey(event);">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="control-label col-sm-2 col-sm-offset-0 ">
								<input type="email" class="form-control" name="Eposta" placeholder="<%=Email%>" value="<%=Email%>" required placeholder="" readonly>
							</div>
							</div>
...
<div class="form-group">
      ...
      <div class="col-sm-7">
        <input type="text" class="form-control" name="WebPage" placeholder="http://www.adresim.com" >
      </div>
    </div>
							...
							<div class="control-label col-sm-2 col-sm-offset-0 ">
								<input type="text" class="form-control" name="WebPage2" placeholder="http://www.adresim.com" >
							</div>
							</div>
