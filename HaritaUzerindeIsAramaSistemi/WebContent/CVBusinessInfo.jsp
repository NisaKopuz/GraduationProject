...
<body>
	...
	<form class="form-horizontal" data-toggle="validator" name="sform"
		method="POST" action="CVBusinessServlet" data-fv-framework="bootstrap"
		...
		<div class="container">
			...
			<ul class="nav nav-pills col-md-offset-2   ">
				...
				<li><a data-toggle="pill" href="CVPersonalInformation.jsp">Kişisel
						Bilgiler</a></li>
				<li><a data-toggle="pill" href="CVEducationalInfo.jsp">Eğitim
						Bilgileri</a></li>
				<li class="active"><a data-toggle="pill"
					href=" CVBusinessInfo.jsp">İş Deneyimi</a></li>
					...
					<div class="container center ">
						...
						<div class="form-group">
							<label class="control-label col-sm-5" for="FirmName">Firma
								Adı * &nbsp;&nbsp;&nbsp;:</label>
							<div class="col-sm-7">
								<input type="text" class="form-control" name="FirmName" required placeholder="">
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" id="datepicker" class="form-control"
									name="FirmStartDate" required placeholder="">
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input TYPE=radio name="FirmContinue" value="Devam Ediyorum">&nbsp;Devam
								Ediyor
							</div>
						</div>				
						...
						<div class="form-group">
							<label class="control-label col-sm-5" for="PositionAtFirm">Firmadaki
								Pozisyon* &nbsp;&nbsp;&nbsp;:</label>
							<div class="col-sm-7">
								<input type="text" class="form-control" name="PositionAtFirm"  required placeholder=""> 
						...
						<div class="form-group">
							<label class="control-label col-sm-5" for="Explanation">Ek
								Açıklama &nbsp;&nbsp;&nbsp;:</label>
							<div class="col-sm-7">
								<textarea class="form-control" name="Explanation" maxlength="120"></textarea>
							</div>
						</div>
						<div class="form-group">
							<div class="col-sm-offset-2 col-sm-8">

							<a href="CVBusinessInfo.jsp" role="button" class="btn btn-success">Temizle</a>
 	                        <button type="submit" onclick="form.action='CVBusinessServlet2';" class="btn btn-success" >Yeni İş
